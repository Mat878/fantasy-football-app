...
This is an application for the Fantasy Premier League, a game based on the English Premier League. Fantasy football allows participants to create a virtual team of real life football players. These teams earn points based on the actual performances of players in premier league matches. The application displays sorted fixtures and player statistics for up to 5 weeks. It also shows the goalscorcer and clean sheet odds for the upcoming gameweek.
